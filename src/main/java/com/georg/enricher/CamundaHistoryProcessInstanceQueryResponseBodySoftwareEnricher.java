...
@ApplicationScoped
public class CamundaHistoryProcessInstanceQueryResponseBodySoftwareEnricher implements Enricher<Uni<CamundaHistoryProcessInstanceQueryResponseBody>> {
    @RestClient
                        ...
                        historyProcessVariableRestClient.get(CamundaHistoryVariableInstanceQueryRequestBody.builder()
                                ...
                                .transform(camundaHistoryVariableInstanceQueryResponseBodies ->
                                        camundaHistoryProcessInstanceQueryResponseBody.toBuilder()
                                                .software(camundaHistoryVariableInstanceQueryResponseBodies.get(0).getValue())
                                                .build())
                                .onFailure()
